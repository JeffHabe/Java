...
public class perfect_numbers {
    ...
    int check_input() {
        ...
        if (n <= 0 || n >= 10) {
            /*判斷測試次數是在範圍內*/
            System.out.print("測試次數超過出範圍棋(0 < n < 10)");
            System.exit(0);
        }
        return n;
    }
    ...
    public static void main(String[] args) {
        /*a=bc
        input consists 
        first line of the input file contains an integer n (0<n<10)
        each test case consists of a positive integer p where (0<p<10^15)
        output contain one word in a line for each test case 
        is perfect number ,show 'perfect'
        not 'nonperfect' 
         */
        perfect_numbers pfnum = new perfect_numbers();
        ...
        pfnum.showAns(n, inStr, outStr);
        /*執行pfnum物件內的showAns方法-用於印出答案*/
